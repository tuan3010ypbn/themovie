    ...
    <>
      <div className="sidebar">
        <div className="grid md:grid-cols-[260px,1fr] grid-cols-[1fr] gap-4 md:gap-8 pl-5 pr-5 lg:pl-0 lg:pr-0 ">
          <div>
            <div className="shadow-[0_2px_8px_rgba(0,0,0,0.1)] flex justify-between flex-wrap items-center p-4 rounded-lg shadow-md border border-gray-200 bg-white">
              <span className="text-16 font-semibold">Sort</span>
              <img className="w-4 h-4" src="./images/next.svg" alt="" />
            </div>
            <div className="mt-3">
              <div className="shadow-[0_2px_8px_rgba(0,0,0,0.1)] flex justify-between items-center p-4 rounded-lg shadow-md border-t border-gray-200 bg-white">
                ...
                <ul id="with_genres" className=" mt-4">
                  <li className="border border-gray-400 rounded-[14px] inline-block px-[13px] py-[5px] text-sm mt-2 text-left mr-2">
                    <a
                      ...
                      href="/discover/tv?with_genres=10759"
                    >
                      Action &amp; Adventure
                    </a>
                  </li>
                  <li className="border border-gray-400 rounded-[14px] inline-block px-[13px] py-[5px] text-sm mt-2 text-left mr-2">
                    <a
                      className="no-underline"
                      href="/discover/tv?with_genres=10762"
                    >
                      Kids
                    </a>
                  </li>
                  <li className="border border-gray-400 rounded-[14px] inline-block px-[13px] py-[5px] text-sm mt-2 text-left mr-2">
                    <a
                      className="no-underline"
                      href="/discover/tv?with_genres=10763"
                    >
                      News
                    </a>
                  </li>
                  <li className="border border-gray-400 rounded-[14px] inline-block px-[13px] py-[5px] text-sm mt-2 text-left mr-2">
                    <a
                      className="no-underline"
                      href="/discover/tv?with_genres=9648"
                    >
                      Phim Bí Ẩn
                    </a>
                  </li>
                  <li className="border border-gray-400 rounded-[14px] inline-block px-[13px] py-[5px] text-sm mt-2 text-left mr-2">
                    <a
                      className="no-underline"
                      href="/discover/tv?with_genres=18"
                    >
                      Phim Chính Kịch
                    </a>
                  </li>
                  <li className="border border-gray-400 rounded-[14px] inline-block px-[13px] py-[5px] text-sm mt-2 text-left mr-2">
                    <a
                      className="no-underline"
                      href="/discover/tv?with_genres=10751"
                    >
                      Phim Gia Đình
                    </a>
                  </li>
                  <li className="border border-gray-400 rounded-[14px] inline-block px-[13px] py-[5px] text-sm mt-2 text-left mr-2">
                    <a
                      className="no-underline"
                      href="/discover/tv?with_genres=16"
                    >
                      Phim Hoạt Hình
                    </a>
                  </li>
                  <li className="border border-gray-400 rounded-[14px] inline-block px-[13px] py-[5px] text-sm mt-2 text-left mr-2">
                    <a
                      className="no-underline"
                      href="/discover/tv?with_genres=35"
                    >
                      Phim Hài
                    </a>
                  </li>
                  <li className="border border-gray-400 rounded-[14px] inline-block px-[13px] py-[5px] text-sm mt-2 text-left mr-2">
                    <a
                      className="no-underline"
                      href="/discover/tv?with_genres=80"
                    >
                      Phim Hình Sự
                    </a>
                  </li>
                  <li className="border border-gray-400 rounded-[14px] inline-block px-[13px] py-[5px] text-sm mt-2 text-left mr-2">
                    <a
                      className="no-underline"
                      href="/discover/tv?with_genres=37"
                    >
                      Phim Miền Tây
                    </a>
                  </li>
                  <li className="border border-gray-400 rounded-[14px] inline-block px-[13px] py-[5px] text-sm mt-2 text-left mr-2">
                    <a
                      className="no-underline"
                      href="/discover/tv?with_genres=99"
                    >
                      Phim Tài Liệu
                    </a>
                  </li>
                  <li className="border border-gray-400 rounded-[14px] inline-block px-[13px] py-[5px] text-sm mt-2 text-left mr-2">
                    <a
                      className="no-underline"
                      href="/discover/tv?with_genres=10764"
                    >
                      Reality
                    </a>
                  </li>
                  <li className="border border-gray-400 rounded-[14px] inline-block px-[13px] py-[5px] text-sm mt-2 text-left mr-2">
                    <a
                      className="no-underline"
                      href="/discover/tv?with_genres=10765"
                    >
                      Sci-Fi &amp; Fantasy
                    </a>
                  </li>
                  <li className="border border-gray-400 rounded-[14px] inline-block px-[13px] py-[5px] text-sm mt-2 text-left mr-2">
                    <a
                      className="no-underline"
                      href="/discover/tv?with_genres=10766"
                    >
                      Soap
                    </a>
                  </li>
                  <li className="border border-gray-400 rounded-[14px] inline-block px-[13px] py-[5px] text-sm mt-2 text-left mr-2">
                    <a
                      className="no-underline"
                      href="/discover/tv?with_genres=10767"
                    >
                      Talk
                    </a>
                  </li>
                  <li className="border border-gray-400 rounded-[14px] inline-block px-[13px] py-[5px] text-sm mt-2 text-left mr-2">
                    <a
                      className="no-underline"
                      href="/discover/tv?with_genres=10768"
                    >
                      War &amp; Politics
                    </a>
                  </li>
